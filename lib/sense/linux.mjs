...
/** AT-SPI stubs / chrome that are never human focus targets. */
const A11Y_SKIP_FOCUS = [
  "xembedsniproxy",
  "gmenudbusmenuproxy",
  "kaccess",
];

/** Extra noise apps when listing windows. */
const A11Y_SKIP_WINDOWS = [
  ...A11Y_SKIP_FOCUS,
  "foreground-booster",
  "kded6",
  "ksecretd",
...
async function listWindowsViaA11y() {
  ...
  const skip = JSON.stringify(A11Y_SKIP_WINDOWS);
...
export async function getA11yFocus() {
  ...
  const skip = JSON.stringify(A11Y_SKIP_FOCUS);
