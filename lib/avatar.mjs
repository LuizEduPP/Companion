/**
 * Avatar face — parametric layout (host draws). Model controls every channel.
 * Per-side eyes/brows, mouth, color, accents. No named emotions / no free SVG.
 * Clamps = SVG I/O wire.
 */

/** Classic resting pose until the model sends a face. */
...
export function normalizeFace(raw, prior = null) {
  ...
  // Ignore free-SVG attempts — layout is parametric.
