...
async function thinkAlive({
  ...
  const user = [
    ...
    "Knows are durable beliefs — habits/preferences/tools/patterns. learn.knows every turn ([] ok). Never rephrase an existing Know. Never learn current focus/file/clipboard path or companion meta.",
    thin
